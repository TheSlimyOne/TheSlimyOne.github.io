...
function displayClubEntry() {
    window.location.href = "../HTML/clubEntry.html";
}
...
function displayClubDistanceEntryForm(c) {
    ...
    window.location.href = "../HTML/clubDistanceEntry.html"; // redirect to entry form
}
...
function displayAbout() {
    // your code here
    window.location.href = "../HTML/clubAbout.html";
}

// navigate to "Penalty Info" screen
function displayPenaltyInfo() {
    window.location.href = "../HTML/clubPenaltyInfo.html";
}
